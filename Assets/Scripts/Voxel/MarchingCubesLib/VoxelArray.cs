...
namespace MarchingCubesProject
{
    ...
    public class VoxelArray
    {
        ...
        /// <summary>
        /// Get interpolated voxel value at world coordinates.
        /// This is a convenience method that works with non-normalized coordinates.
        /// </summary>
        /// <param name="x">The x coordinate.</param>
        /// <param name="y">The y coordinate.</param>
        /// <param name="z">The z coordinate.</param>
        /// <returns>The interpolated voxel value</returns>
        public float GetInterpolatedValue(float x, float y, float z)
        {
